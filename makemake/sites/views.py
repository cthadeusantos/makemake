...
from makemake.core.custom_functions import create_or_update_object
...
def new(request):
    ...
    if request.method == 'POST':    # Newly filled form
        ...
        if form.is_valid():
            ...
            try:
                create_or_update_object(request, Site, data)
    ...
    if request.user.has_perm('global_permissions.entra_em_sites'):
        ...
        if request.method == 'POST':    # Newly filled form
            ...
            if form.is_valid():
                ...
                create_or_update_object(request, Site, data, pk)

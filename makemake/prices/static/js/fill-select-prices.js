...
document.getElementById('add-input-button').addEventListener('click', function () {
    ...
    inputComponent.className = 'w-6/12 flex-1 mr-2 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500';
    
    // Add the select element
    const selectOption = document.createElement('select');
    selectOption.id = 'select-category-' + inputCounter;
    selectOption.name = 'select-category-' + inputCounter;
    selectOption.className = 'w-2/12 mr-2 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500';
    fetchResultsPriceLabel(selectOption.id); // Build select category
    ...
    inputQty.className = 'w-2/12 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-right';
